...
if(session.getAttribute("__id") == null){
	...
	if(request.getParameter("_explanation") != null && request.getParameter("_url") != null){
		Oracle_DAO oracle = new Oracle_DAO();
		oracle.OracleRegistUrl(session.getAttribute("__id").toString(), session.getAttribute("__kategorie").toString(), request.getParameter("_explanation"), request.getParameter("_url"), favorite, priv);
		%>
  ...
  <div align = "center" style ="width:400px; margin-top:20%">
	<h1>URL 등록</h1>
      <div style="padding-top: 20px;">
         <form method="post" action="Url_Regist.jsp" name = "form">
           <input type="text" class="form-control" placeholder="<%=session.getAttribute("__kategorie") %>" disabled><br>
     	   <input type="text" class="form-control" placeholder="설명" name="_explanation" maxlength="13"><br>
     	   <input type="text" class="form-control" placeholder="URL" name="_url" maxlength="500"><br>
    	   ...
    	   <span style = "float:center; color:orange; margin-right:60px">
     	   ...
     	   <div>
    	     <input type="Button" onClick="Check1()" class="btn btn-primary" value="등록"
