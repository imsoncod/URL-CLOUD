...
%>
				<div align="center"
					...
					<div align="left" style = "margin-bottom:4px; margin-top:30px; margin-left:15px">
						...
						<input id = "searchtext" type = "text" name = "_search" placeholder = "　　　　　　　　　　검색 " value = "<%=searchText %>" style = "margin-bottom:2px; text-align:left; float:right;margin-right:2px">
						<select style="margin-left:347px ;height:25px; float:right; margin-right:2px" id = "typeselect">
						<% 
							if(searchType.equals("explanation")){
						%>
							<option value = "explanation" selected>설명</option>
						...
						<div>
							<table id = "boardtable" class="table table-striped"
								...
								<%
									...
									oracle.OracleGetURLOfSearch(session.getAttribute("__id").toString(), kategorie,searchType,searchText);
							...
							<script>
								function pagenation2(){
									document.pageForm._startnum.value = 20;
