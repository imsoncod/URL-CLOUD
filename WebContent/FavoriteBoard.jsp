...
<link rel="stylesheet" href="css/bootstrap.min.css">
	...
	<script>
						function Check2(){
							if(document.getElementById("_즐겨찾기").checked==false){
...
<body>
				<div align="center"
					...
					%>
					<form action = "Board.jsp" method = "post" name = "favoriteForm">
					...
					<div align="left" style = "margin-bottom:4px; margin-top:30px; margin-left:15px">
						...
						<input type = "checkbox" id = "_즐겨찾기" onclick = "Check2()" value = "즐겨찾기" checked> <span style = "color:orange"><b>즐겨찾기</b></span>만 보기
						...
						<div>
							<table class="table table-striped"
								...
								<tbody>
									...
									oracle.OracleGetFavoriteURL(session.getAttribute("__id").toString(), kategorie);
							...
							<form action = "Board.jsp" method = "post" name = "pageForm">
								...
								<input type = "hidden" name = "_endnum" value = "10">
